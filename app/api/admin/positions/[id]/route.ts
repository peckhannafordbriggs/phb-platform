...
import { updatePosition } from "@/lib/admin/service";
...
export async function PATCH(
  ...
  return withAdmin("/api/admin/positions/[id]", async (viewer) => {
    ...
    const result = await updatePosition(viewer.id, id, parsed.data);
